...
var About = function (_Component) {
  ...
  _createClass(About, [{
    ...
    value: function componentDidMount() {
      if (this.width > 1025) {
        _windowOrGlobal2.default.document.addEventListener("mousemove", this.float);
      }
    }
  }, {
    ...
    value: function componentWillUnmount() {
      if (this.width > 1025) {
        _windowOrGlobal2.default.document.removeEventListener("mousemove", this.float);
      }
    }
  }, {
    key: 'float',
    ...
    value: function render() {
      console.log(_windowOrGlobal2.default.document);
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: _style2.default.float, style: this.state.float },
          _react2.default.createElement(
            _BlackBox2.default,
            null,
            _react2.default.createElement(

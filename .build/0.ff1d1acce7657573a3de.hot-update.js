...
var Header = function (_Component) {
  ...
  _createClass(Header, [{
    ...
    value: function componentDidMount() {
      if (this.width > 1025) {
        this.docs.addEventListener("mousemove", this.floatStyle);
      }
    }
  }, {
    ...
    value: function componentWillUnmount() {
      if (this.width > 1025) {
        this.docs.removeEventListener("mousemove", this.floatStyle);
      }
    }
  }, {
    key: 'floatStyle',
    value: function floatStyle(e) {
      this.setState({
        floatStyle: {
          transform: 'rotate(' + (e.clientX - this.width / 2) / 300 + 'deg)'
        }
      });
    }
  }, {
